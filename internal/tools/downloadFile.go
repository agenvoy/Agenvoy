...
func registDownloadFile() {
	toolRegister.Regist(toolRegister.Def{
		...
		AlwaysAllow: false,
		Concurrent:  true,
		Description: "Download a binary file from a URL to local disk. Use for tar.gz, images, archives, or any non-text content. For JSON/HTML/markdown use http_request or fetch_page(save=true).",
