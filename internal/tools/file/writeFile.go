...
func registWriteFile() {
	toolRegister.Regist(toolRegister.Def{
		Name:        "write_file",
		Description: "Create a new file or fully rewrite. For targeted edits use patch_file. Call read_files after to verify. One write per change; trust success strings. Default export path: ~/Downloads or ~/.config/agenvoy/download/.",
